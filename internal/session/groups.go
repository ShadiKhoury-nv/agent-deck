...
const (
	...
	ItemTypeSession
	ItemTypeExternalHeader // Collapsible "External (N not managed)" section header
	ItemTypeExternal       // An external (non-managed) agent process
)
...
type Item struct {
	...
	Group               *Group
	Session             *Instance
	External            *ExternalProcess // Non-nil when Type == ItemTypeExternal
